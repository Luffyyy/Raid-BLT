...
private:
	LogLevel mLevel = LogLevel::LOGGING_DEBUG;
};
...
#define PD2HOOK_LOG_LUA_DEBUG(msg) PD2HOOK_LOG_LEVEL(msg, pd2hook::Logging::LogType::LOGGING_DEBUG, NULL, -1, FOREGROUND_RED | FOREGROUND_BLUE | FOREGROUND_GREEN | FOREGROUND_INTENSITY)
#define PD2HOOK_LOG_LUA_TRACE(msg) PD2HOOK_LOG_LEVEL(msg, pd2hook::Logging::LogType::LOGGING_TRACE, NULL, -1, FOREGROUND_GREEN | FOREGROUND_INTENSITY)
#define PD2HOOK_LOG_LUA_INFO(msg) PD2HOOK_LOG_LEVEL(msg, pd2hook::Logging::LogType::LOGGING_LOG, NULL, -1, FOREGROUND_BLUE | FOREGROUND_GREEN | FOREGROUND_INTENSITY)
#define PD2HOOK_LOG_LUA_WARN(msg) PD2HOOK_LOG_LEVEL(msg, pd2hook::Logging::LogType::LOGGING_WARN, NULL, -1, FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_INTENSITY)
#define PD2HOOK_LOG_LUA_ERROR(msg) PD2HOOK_LOG_LEVEL(msg, pd2hook::Logging::LogType::LOGGING_ERROR, NULL, -1, FOREGROUND_RED | FOREGROUND_INTENSITY)
